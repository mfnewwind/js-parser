...
describe('Unit test for lib/line-number.js', function () {
  describe('getLineNumber', function () {
    ...
    describe('CR only', function () {
      it('should return 0', function () {
        expect(getLineNumber('0\r2', 0)).to.equal(0);
      });

      it('should return 0', function () {
        expect(getLineNumber('0\r2', 1)).to.equal(0);
      });

      it('should return 1', function () {
        expect(getLineNumber('0\r2', 2)).to.equal(1);
      });

      it('should return 2', function () {
        expect(getLineNumber('\r\r2', 2)).to.equal(2);
      });
    });
